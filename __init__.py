...
from Forms import CreateUserForm, CreateGradeForm, CreateAnnouncementForm, CreateProgressreportForm
...
#Retrieve announcements
    ...
    return render_template('home.html', announcements_list=announcements_list, grades_list=grades_list, gradecount=gradecount,
...
#Retrieve announcements
    ...
    return render_template('contactUs.html', grades_list=grades_list, progressreports_list=progressreports_list, form=create_progressreport_form, users_list=users_list,
